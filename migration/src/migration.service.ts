...
import { stores } from '@visit_stats_backend/migration/src/store';
...
import { Migration } from '@visit_stats_backend/migration/src/command/repository/migration.repository';
